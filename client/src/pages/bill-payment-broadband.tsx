...
const savedAccounts: SavedAccount[] = [
  { id: "1", name: "Home WiFi", accountNumber: "1234567890", provider: "Jio Fiber", plan: "100 Mbps", billAmount: "₹899", dueDate: "25 Oct 2024" },
  { id: "2", name: "Office Internet", accountNumber: "9876543210", provider: "Airtel Xstream", plan: "200 Mbps", billAmount: "₹1,499", dueDate: "28 Oct 2024" },
  { id: "3", name: "Parents WiFi", accountNumber: "5555666677", provider: "ACT Fibernet", plan: "150 Mbps", billAmount: "₹999", dueDate: "30 Oct 2024" },
];

const allTransactions: Transaction[] = [
  { id: "1", accountId: "1", accountName: "Home WiFi", accountNumber: "1234567890", provider: "Jio Fiber", amount: 899, date: "20 Sep 2024", time: "10:30 AM", status: "Success" },
  { id: "2", accountId: "1", accountName: "Home WiFi", accountNumber: "1234567890", provider: "Jio Fiber", amount: 899, date: "20 Aug 2024", time: "03:15 PM", status: "Success" },
  { id: "3", accountId: "2", accountName: "Office Internet", accountNumber: "9876543210", provider: "Airtel Xstream", amount: 1499, date: "22 Sep 2024", time: "02:45 PM", status: "Success" },
  { id: "4", accountId: "1", accountName: "Home WiFi", accountNumber: "1234567890", provider: "Jio Fiber", amount: 899, date: "20 Jul 2024", time: "11:45 AM", status: "Success" },
  { id: "5", accountId: "3", accountName: "Parents WiFi", accountNumber: "5555666677", provider: "ACT Fibernet", amount: 999, date: "15 Sep 2024", time: "04:20 PM", status: "Success" },
  { id: "6", accountId: "2", accountName: "Office Internet", accountNumber: "9876543210", provider: "Airtel Xstream", amount: 1499, date: "22 Aug 2024", time: "01:15 PM", status: "Success" },
];

export default function BillPaymentBroadband() {
  ...
  const handleAccountClick = (account: SavedAccount) => {
    navigate(`/broadband-bill/account/${account.id}`);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="relative border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6" data-testid="broadband-bill-summary">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-4xl font-light text-white tracking-tight" data-testid="text-total-broadband-bills">
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-white/50 uppercase tracking-widest">{transaction.provider} • {transaction.accountNumber}</p>
