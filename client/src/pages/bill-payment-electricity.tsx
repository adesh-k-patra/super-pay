...
const savedAccounts: SavedAccount[] = [
  { id: "1", name: "Home", consumerNumber: "1234567890", provider: "Tata Power", billAmount: "₹1,250", dueDate: "25 Oct 2024" },
  { id: "2", name: "Shop", consumerNumber: "9876543210", provider: "Adani Electricity", billAmount: "₹2,150", dueDate: "28 Oct 2024" },
  { id: "3", name: "Office", consumerNumber: "5555666677", provider: "BESCOM", billAmount: "₹3,500", dueDate: "30 Oct 2024" },
];

const allTransactions: Transaction[] = [
  { id: "1", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Tata Power", amount: 1250, date: "15 Sep 2024", time: "10:30 AM", status: "Success" },
  { id: "2", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Tata Power", amount: 1180, date: "10 Aug 2024", time: "03:15 PM", status: "Success" },
  { id: "3", accountId: "2", accountName: "Shop", consumerNumber: "9876543210", provider: "Adani Electricity", amount: 2150, date: "05 Aug 2024", time: "02:45 PM", status: "Success" },
  { id: "4", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Tata Power", amount: 1320, date: "15 Jul 2024", time: "11:30 AM", status: "Success" },
  { id: "5", accountId: "3", accountName: "Office", consumerNumber: "5555666677", provider: "BESCOM", amount: 3500, date: "10 Jul 2024", time: "04:20 PM", status: "Success" },
  { id: "6", accountId: "2", accountName: "Shop", consumerNumber: "9876543210", provider: "Adani Electricity", amount: 2050, date: "01 Jul 2024", time: "01:15 PM", status: "Success" },
];

export default function BillPaymentElectricity() {
  ...
  const handleAccountClick = (account: SavedAccount) => {
    navigate(`/electricity-bill/account/${account.id}`);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="relative border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6" data-testid="electricity-bill-summary">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-4xl font-light text-white tracking-tight" data-testid="text-total-electricity-bills">
