...
const savedAccounts: SavedAccount[] = [
  { id: "1", name: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", billAmount: "₹850", dueDate: "28 Oct 2024" },
  { id: "2", name: "Parents Home", consumerNumber: "9876543210", provider: "Gujarat Gas", billAmount: "₹650", dueDate: "25 Oct 2024" },
  { id: "3", name: "Shop", consumerNumber: "5555666677", provider: "MGL", billAmount: "₹1,200", dueDate: "30 Oct 2024" },
];

const allTransactions: Transaction[] = [
  { id: "1", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 850, date: "15 Sep 2024", time: "10:30 AM", status: "Success" },
  { id: "2", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 820, date: "10 Aug 2024", time: "03:15 PM", status: "Success" },
  { id: "3", accountId: "2", accountName: "Parents Home", consumerNumber: "9876543210", provider: "Gujarat Gas", amount: 650, date: "12 Sep 2024", time: "02:45 PM", status: "Success" },
  { id: "4", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 900, date: "15 Jul 2024", time: "11:45 AM", status: "Success" },
  { id: "5", accountId: "3", accountName: "Shop", consumerNumber: "5555666677", provider: "MGL", amount: 1200, date: "10 Sep 2024", time: "04:20 PM", status: "Success" },
  { id: "6", accountId: "2", accountName: "Parents Home", consumerNumber: "9876543210", provider: "Gujarat Gas", amount: 680, date: "12 Aug 2024", time: "01:15 PM", status: "Success" },
];

export default function BillPaymentGas() {
  ...
  const handleAccountClick = (account: SavedAccount) => {
    navigate(`/gas-bill/account/${account.id}`);
  };
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-white/50 uppercase tracking-widest font-light">All Providers</p>
          </div>
          <Button
            variant="ghost"
            size="sm"
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-white/50 uppercase tracking-widest">{transaction.provider} • {transaction.consumerNumber}</p>
