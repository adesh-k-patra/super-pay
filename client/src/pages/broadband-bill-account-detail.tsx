...
const savedAccounts = [
  { id: "1", name: "Home WiFi", accountNumber: "1234567890", provider: "Jio Fiber", plan: "100 Mbps", billAmount: "₹899", dueAmount: 899, dueDate: "25 Oct 2024", lastPaid: "20 Sep 2024" },
  { id: "2", name: "Office Internet", accountNumber: "9876543210", provider: "Airtel Xstream", plan: "200 Mbps", billAmount: "₹1,499", dueAmount: 1499, dueDate: "28 Oct 2024", lastPaid: "22 Sep 2024" },
  { id: "3", name: "Parents WiFi", accountNumber: "5555666677", provider: "ACT Fibernet", plan: "150 Mbps", billAmount: "₹999", dueAmount: 999, dueDate: "30 Oct 2024", lastPaid: "15 Sep 2024" },
];

const allTransactions = [
  { id: "1", accountId: "1", amount: 899, date: "20 Sep 2024", status: "Success", time: "10:30 AM", billMonth: "September 2024" },
  { id: "2", accountId: "1", amount: 899, date: "20 Aug 2024", status: "Success", time: "03:15 PM", billMonth: "August 2024" },
  { id: "3", accountId: "2", amount: 1499, date: "22 Sep 2024", status: "Success", time: "02:45 PM", billMonth: "September 2024" },
  { id: "4", accountId: "1", amount: 899, date: "20 Jul 2024", status: "Success", time: "11:45 AM", billMonth: "July 2024" },
  { id: "5", accountId: "3", amount: 999, date: "15 Sep 2024", status: "Success", time: "04:20 PM", billMonth: "September 2024" },
  { id: "6", accountId: "2", amount: 1499, date: "22 Aug 2024", status: "Success", time: "01:15 PM", billMonth: "August 2024" },
];

const dueBills = [
  { id: "d1", accountId: "1", amount: 899, dueDate: "25 Oct 2024", billMonth: "October 2024" },
];

const billAmounts = [
  { id: "a1", amount: 500, label: "Partial Payment" },
  { id: "a2", amount: 899, label: "Full Bill", recommended: true },
  { id: "a3", amount: 1500, label: "Extra Payment" },
  { id: "a4", amount: 2000, label: "Advance Payment" },
];

export default function BroadbandBillAccountDetail() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/broadband-bill/account/:id");
  ...
  const handleProceedToPayment = () => {
    ...
    const paymentParams = new URLSearchParams({
      ...
      returnUrl: `/broadband-bill/account/${account.id}`
    });
  ...
  const confirmDeleteAccount = () => {
    ...
    navigate("/broadband-bill");
  };

  const handleTransactionClick = (transaction: any) => {
    navigate(`/broadband-bill/transaction/${transaction.id}`);
  };
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              onClick={() => {
                ...
                navigate(`/add-broadband-account?${params.toString()}`);
              }}
              className="text-white/60 hover:text-white hover:bg-white/10 p-2 rounded-none"
        ...
        <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 border border-white/20 flex items-center justify-center">
              <Wifi className="h-7 w-7 text-white/60" />
            </div>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-[10px] text-white/50 uppercase tracking-widest">Account Number</span>
              <span className="text-white font-light">{account.accountNumber}</span>
            </div>
            <div className="flex justify-between">
        ...
        <DialogContent className="bg-black border-white/20 text-white max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-white/50 text-[10px] uppercase tracking-widest">
              Choose amount for {account.accountNumber}
            </DialogDescription>
          </DialogHeader>
        ...
        <AlertDialogContent className="bg-black border-white/20 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/60 text-sm">
              Are you sure you want to delete "{account.name}" ({account.accountNumber})? This action cannot be undone.
