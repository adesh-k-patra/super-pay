...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home", accountNumber: "BB123456789", provider: "Airtel Broadband", amount: 899, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", plan: "100 Mbps Unlimited", billPeriod: "Sep 2024" },
  { id: "2", accountId: "1", accountName: "Home", accountNumber: "BB123456789", provider: "Airtel Broadband", amount: 899, date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", plan: "100 Mbps Unlimited", billPeriod: "Aug 2024" },
  { id: "3", accountId: "2", accountName: "Office", accountNumber: "BB987654321", provider: "ACT Fibernet", amount: 1299, date: "05 Aug 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", plan: "200 Mbps Unlimited", billPeriod: "Aug 2024" },
];

export default function BroadbandBillTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/broadband-bill/transaction/:id");
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Account Number</span>
              <span className="text-white font-light">{transaction.accountNumber}</span>
            </div>
            <div className="flex justify-between">
