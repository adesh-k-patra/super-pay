...
import { 
  ArrowLeft, Bus, Calendar, Clock, Users, CreditCard, 
...
export default function BusDetail() {
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/my-trips/buses")} data-testid="button-back-list">
            Back to Buses
          </Button>
        </div>
      </div>
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'completed': return 'bg-white/10 text-white/80 border-white/20/30';
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-start gap-4">
              <div className="p-3 bg-white/10 border border-white/20/30 rounded-none">
                <Bus className="h-8 w-8 text-white/80" strokeWidth={1} />
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6">
              <div className="mb-6">
                <h3 className="text-xs uppercase tracking-widest text-white/60 font-light flex items-center gap-2">
                  <Bus className="h-4 w-4" strokeWidth={1} />
                  Bus Details
                </h3>
              </div>
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 px-4">
                    <div className="relative">
                      ...
                      <Bus className="h-5 w-5 text-white/80 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black px-1" strokeWidth={1} />
                    </div>
                    <div className="text-center text-white/60 text-sm mt-2 font-light">
                      {bookingData.operatorName || 'Direct'}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Bus Number</div>
                  ...
                  <div>
                    ...
                    <div className="font-medium flex items-center gap-1">
                      ...
                      {bookingData.seatClass || 'Standard'}
                    </div>
                  </div>
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Boarding Point</div>
                    <div className="font-medium">{bookingData.platform || 'TBA'}</div>
                  </div>
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Drop Point</div>
                    <div className="font-medium">{bookingData.boardingGate || 'TBA'}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            {/* Travel Tips */}
            <div className="bg-white/5 border border-white/20/30 p-4">
