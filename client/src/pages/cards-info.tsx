import { ArrowLeft, Check, CreditCard, Shield, Zap, DollarSign, Clock, AlertTriangle, TrendingUp, Target, Award, Lock } from "lucide-react";
...
export default function CardsInfo() {
  ...
  const features = [
    { 
      ...
      desc: "Manage all your credit and debit cards from multiple banks in a single dashboard.",
      highlight: "Unified view"
    },
    { 
      icon: Award, 
      title: "REWARD POINTS TRACKING", 
      desc: "Track and redeem reward points from all your cards with real-time balance updates.",
      highlight: "Live tracking"
    },
    { 
      icon: Lock, 
      title: "INSTANT CARD LOCK", 
      desc: "Lock or unlock your cards instantly for security without calling the bank.",
      highlight: "One-tap control"
    },
    { 
      icon: DollarSign, 
      title: "LIMIT MANAGEMENT", 
      desc: "View available credit limits, used amounts, and upcoming due dates for all cards.",
      highlight: "Real-time limits"
    },
    { 
      icon: Shield, 
      title: "SECURE STORAGE", 
      desc: "Your card details are encrypted and stored securely with bank-grade protection.",
      highlight: "Bank-level security"
    },
  ];

  const steps = [
    { step: "1", title: "Add Cards", desc: "Link your credit and debit cards securely" },
    { step: "2", title: "Track Usage", desc: "Monitor spending and available limits" },
    { step: "3", title: "Manage Controls", desc: "Lock/unlock cards and set preferences" },
    { step: "4", title: "Earn Rewards", desc: "Track and redeem your reward points!" }
  ];

  const terms = [
    { label: "Supported Cards", desc: "Credit and debit cards from all banks", value: "All Banks" },
    { label: "Card Linking", desc: "No charges for adding cards", value: "Free" },
    { label: "Real-time Updates", desc: "Instant balance and limit sync", value: "Live Sync" },
    { label: "Card Lock/Unlock", desc: "Instant security control", value: "Available" },
    { label: "Reward Tracking", desc: "Monitor points across all cards", value: "Enabled" },
    { label: "Transaction History", desc: "Detailed payment records", value: "Complete" },
  ];
    ...
    <div className="min-h-screen bg-black text-white pb-32">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">CARDS</h1>
      ...
      <div className="pt-20 px-4 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="border border-white/20 p-5 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl">
          <div className="text-center space-y-3">
            ...
            <p className="text-base text-white/70 max-w-2xl mx-auto font-light" data-testid="text-subtitle">
              Smart Card Management & Control
            </p>
            <p className="text-sm text-white/60 leading-relaxed font-light max-w-3xl mx-auto">
              <span className="font-medium text-white">Cards</span> helps you manage all your credit and debit cards in one place. Track spending, monitor limits, lock cards instantly, and redeem reward points with ease.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-white/50 text-[11px] font-light">Set up card management in minutes</p>
        ...
        <div className="space-y-3">
          <label className="text-white/60 text-xs uppercase tracking-widest font-light flex items-center gap-2">
            ...
            Why Choose Cards Management
          </label>
          <div className="border border-white/20 p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                { title: "Centralized Control", desc: "Manage all cards from one dashboard" },
                { title: "Enhanced Security", desc: "Instant lock/unlock for lost cards" },
                { title: "Spending Insights", desc: "Track usage patterns and limits" },
                { title: "Reward Maximization", desc: "Never miss redeeming your points" },
                { title: "Due Date Alerts", desc: "Timely reminders for payments" },
                { title: "Zero Fees", desc: "Free card linking and management" },
              ].map((item, idx) => (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-xs text-white/60 font-light leading-relaxed">
                Card details are encrypted and securely stored. Lock/unlock feature availability depends on bank support. Reward points sync may take up to 24 hours. Always verify card details before adding to the app.
              </p>
