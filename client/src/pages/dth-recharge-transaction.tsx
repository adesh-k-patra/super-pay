...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home DTH", subscriberId: "1234567890", operator: "Tata Play", amount: 499, plan: "Sports HD Pack - Monthly", date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", validity: "30 days", channels: "250+", hd: "50 HD Channels" },
  { id: "2", accountId: "1", accountName: "Home DTH", subscriberId: "1234567890", operator: "Tata Play", amount: 399, plan: "Basic Pack - Monthly", date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", validity: "30 days", channels: "150+", hd: "20 HD Channels" },
  { id: "3", accountId: "2", accountName: "Parents DTH", subscriberId: "9876543210", operator: "Airtel Digital TV", amount: 599, plan: "Family Entertainment Pack", date: "18 Sep 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", validity: "30 days", channels: "300+", hd: "75 HD Channels" },
];

export default function DTHRechargeTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/dth-recharge/transaction/:id");
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Subscriber ID</span>
              <span className="text-white font-light">{transaction.subscriberId}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Channels</span>
              <span className="text-white font-light">{transaction.channels}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">HD Channels</span>
              <span className="text-white font-light">{transaction.hd}</span>
            </div>
          </div>
        </div>
