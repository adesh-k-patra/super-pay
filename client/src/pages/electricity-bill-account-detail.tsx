...
const savedAccounts = [
  { id: "1", name: "Home", consumerNumber: "1234567890", provider: "MSEB", city: "Mumbai", billAmount: "₹1,250", dueAmount: 1250, dueDate: "25 Oct 2024", lastPaid: "15 Sep 2024" },
  { id: "2", name: "Office", consumerNumber: "9876543210", provider: "BSES", city: "Delhi", billAmount: "₹3,450", dueAmount: 3450, dueDate: "28 Oct 2024", lastPaid: "20 Sep 2024" },
  { id: "3", name: "Shop", consumerNumber: "5555666677", provider: "TSSPDCL", city: "Hyderabad", billAmount: "₹2,100", dueAmount: 2100, dueDate: "30 Oct 2024", lastPaid: "10 Sep 2024" },
];

const allTransactions = [
  { id: "1", accountId: "1", amount: 1250, date: "15 Sep 2024", status: "Success", time: "10:30 AM", billMonth: "September 2024" },
  { id: "2", accountId: "1", amount: 1180, date: "10 Aug 2024", status: "Success", time: "03:15 PM", billMonth: "August 2024" },
  { id: "3", accountId: "2", amount: 3450, date: "20 Sep 2024", status: "Success", time: "02:45 PM", billMonth: "September 2024" },
  { id: "4", accountId: "1", amount: 1300, date: "15 Jul 2024", status: "Success", time: "11:45 AM", billMonth: "July 2024" },
  { id: "5", accountId: "3", amount: 2100, date: "10 Sep 2024", status: "Success", time: "04:20 PM", billMonth: "September 2024" },
  { id: "6", accountId: "2", amount: 3200, date: "01 Aug 2024", status: "Success", time: "01:15 PM", billMonth: "August 2024" },
];

const dueBills = [
  { id: "d1", accountId: "1", amount: 1250, dueDate: "25 Oct 2024", billMonth: "October 2024" },
];

const billAmounts = [
  { id: "a1", amount: 500, label: "Partial Payment" },
  { id: "a2", amount: 1000, label: "Mid Amount" },
  { id: "a3", amount: 1250, label: "Full Bill", recommended: true },
  { id: "a4", amount: 2000, label: "Extra Payment" },
];

export default function ElectricityBillAccountDetail() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/electricity-bill/account/:id");
  ...
  const handleProceedToPayment = () => {
    ...
    const paymentParams = new URLSearchParams({
      ...
      returnUrl: `/electricity-bill/account/${account.id}`
    });
  ...
  const handleTransactionClick = (transaction: any) => {
    navigate(`/electricity-bill/transaction/${transaction.id}`);
  };
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              onClick={() => {
                ...
                navigate(`/add-electricity-account?${params.toString()}`);
              }}
              className="text-white/60 hover:text-white hover:bg-white/10 p-2 rounded-none"
