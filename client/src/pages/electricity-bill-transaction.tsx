...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Tata Power", amount: 1250, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", units: "450 kWh", billPeriod: "Aug 2024" },
  { id: "2", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Tata Power", amount: 1180, date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", units: "420 kWh", billPeriod: "Jul 2024" },
  { id: "3", accountId: "2", accountName: "Shop", consumerNumber: "9876543210", provider: "Adani Electricity", amount: 2150, date: "05 Aug 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", units: "680 kWh", billPeriod: "Jul 2024" },
];

export default function ElectricityBillTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/electricity-bill/transaction/:id");
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Units Consumed</span>
