...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 850, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", units: "125 m³", billPeriod: "Aug 2024" },
  { id: "2", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 820, date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", units: "120 m³", billPeriod: "Jul 2024" },
  { id: "3", accountId: "2", accountName: "Parents Home", consumerNumber: "9876543210", provider: "Gujarat Gas", amount: 650, date: "12 Sep 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", units: "95 m³", billPeriod: "Aug 2024" },
  { id: "4", accountId: "1", accountName: "Home", consumerNumber: "1234567890", provider: "Indraprastha Gas", amount: 900, date: "15 Jul 2024", time: "11:45 AM", status: "Success", transactionId: "TXN123456789004", paymentMethod: "UPI", units: "135 m³", billPeriod: "Jun 2024" },
  { id: "5", accountId: "3", accountName: "Shop", consumerNumber: "5555666677", provider: "MGL", amount: 1200, date: "10 Sep 2024", time: "04:20 PM", status: "Success", transactionId: "TXN123456789005", paymentMethod: "UPI", units: "175 m³", billPeriod: "Aug 2024" },
  { id: "6", accountId: "2", accountName: "Parents Home", consumerNumber: "9876543210", provider: "Gujarat Gas", amount: 680, date: "12 Aug 2024", time: "01:15 PM", status: "Success", transactionId: "TXN123456789006", paymentMethod: "UPI", units: "100 m³", billPeriod: "Jul 2024" },
];

export default function GasBillTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/gas-bill/transaction/:id");
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-32">
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-white/50 uppercase tracking-widest font-light">Gas Bill</p>
          </div>
          <div className="w-10" />
        </div>
      </div>
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white font-light">{transaction.consumerNumber}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          <h3 className="text-[10px] text-white/50 uppercase tracking-widest font-light mb-4">Bill Details</h3>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Bill Period</span>
              <span className="text-white font-light">{transaction.billPeriod}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Gas Consumed</span>
              <span className="text-white font-light">{transaction.units}</span>
            </div>
          </div>
        </div>
          ...
          <Button
            onClick={() => {
              const paymentParams = new URLSearchParams({
                ...
                consumerNumber: transaction.consumerNumber,
