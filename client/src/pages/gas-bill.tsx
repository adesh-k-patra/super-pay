...
const savedAccounts = [
  { id: "1", name: "Home", consumerNumber: "GAS123456", provider: "Indraprastha Gas", city: "Delhi", lastBillAmount: 845, dueDate: "15 Oct 2024", status: "Due" },
  { id: "2", name: "Office", consumerNumber: "GAS987654", provider: "Mahanagar Gas", city: "Mumbai", lastBillAmount: 1200, dueDate: "20 Oct 2024", status: "Due" },
  { id: "3", name: "Apartment", consumerNumber: "GAS456789", provider: "Gujarat Gas", city: "Ahmedabad", lastBillAmount: 650, dueDate: "18 Oct 2024", status: "Due" },
  { id: "4", name: "Shop", consumerNumber: "GAS789012", provider: "Indraprastha Gas", city: "Delhi", lastBillAmount: 920, dueDate: "22 Oct 2024", status: "Due" },
  { id: "5", name: "Factory", consumerNumber: "GAS234567", provider: "Mahanagar Gas", city: "Mumbai", lastBillAmount: 2500, dueDate: "25 Oct 2024", status: "Due" },
  { id: "6", name: "Warehouse", consumerNumber: "GAS567890", provider: "Sabarmati Gas", city: "Ahmedabad", lastBillAmount: 1800, dueDate: "28 Oct 2024", status: "Due" },
  { id: "7", name: "Cottage", consumerNumber: "GAS890123", provider: "Green Gas", city: "Pune", lastBillAmount: 450, dueDate: "30 Oct 2024", status: "Due" },
];

const recentTransactions = [
  { id: "1", accountId: "1", accountName: "Home", provider: "Indraprastha Gas", amount: 792, date: "15 Sep 2024", status: "Paid", time: "11:30 AM" },
  { id: "2", accountId: "2", accountName: "Office", provider: "Mahanagar Gas", amount: 1150, date: "20 Sep 2024", status: "Paid", time: "02:45 PM" },
  { id: "3", accountId: "1", accountName: "Home", provider: "Indraprastha Gas", amount: 918, date: "15 Aug 2024", status: "Paid", time: "10:15 AM" },
];

const allTransactions = [
  ...recentTransactions,
  { id: "4", accountId: "2", accountName: "Office", provider: "Mahanagar Gas", amount: 1100, date: "20 Aug 2024", status: "Paid", time: "03:20 PM" },
  { id: "5", accountId: "1", accountName: "Home", provider: "Indraprastha Gas", amount: 850, date: "15 Jul 2024", status: "Paid", time: "09:45 AM" },
  { id: "6", accountId: "3", accountName: "Apartment", provider: "Gujarat Gas", amount: 620, date: "18 Jul 2024", status: "Paid", time: "01:10 PM" },
  { id: "7", accountId: "4", accountName: "Shop", provider: "Indraprastha Gas", amount: 880, date: "22 Jul 2024", status: "Paid", time: "04:30 PM" },
  { id: "8", accountId: "5", accountName: "Factory", provider: "Mahanagar Gas", amount: 2400, date: "25 Jun 2024", status: "Paid", time: "10:15 AM" },
  { id: "9", accountId: "6", accountName: "Warehouse", provider: "Sabarmati Gas", amount: 1750, date: "28 Jun 2024", status: "Paid", time: "02:45 PM" },
  { id: "10", accountId: "7", accountName: "Cottage", provider: "Green Gas", amount: 430, date: "30 Jun 2024", status: "Paid", time: "11:20 AM" },
  { id: "11", accountId: "1", accountName: "Home", provider: "Indraprastha Gas", amount: 795, date: "15 Jun 2024", status: "Paid", time: "09:00 AM" },
  { id: "12", accountId: "2", accountName: "Office", provider: "Mahanagar Gas", amount: 1150, date: "20 May 2024", status: "Paid", time: "03:50 PM" },
];

const duePayments = [
  { id: "d1", accountId: "1", accountName: "Home", provider: "Indraprastha Gas", amount: 845, dueDate: "15 Oct 2024" },
  { id: "d2", accountId: "2", accountName: "Office", provider: "Mahanagar Gas", amount: 1200, dueDate: "20 Oct 2024" },
];

const quickPayAmounts = [500, 800, 1000, 1500, 2000, 3000];
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">GAS BILL</h1>
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        {/* Gas Bill Summary Card */}
        <div className="relative border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6" data-testid="gas-bill-summary">
          <div className="space-y-6">
            {/* Total Bills Display */}
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <p className="text-xs text-white/50 uppercase tracking-widest font-light">Total Gas Bills</p>
                <div className="flex items-center gap-2">
                  <Flame className="h-3 w-3 text-white/60" />
                  <span className="text-xs text-white/60">This Month</span>
                </div>
              </div>
              <p className="text-4xl font-light text-white tracking-tight" data-testid="text-total-gas-bills">
            ...
            <div className="grid grid-cols-3 gap-3 pt-4 border-t border-white/10">
              ...
              <div className="space-y-1 text-center" data-testid="card-connections">
                <p className="text-lg font-light text-white" data-testid="text-connections">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="recent" className="mt-6 space-y-3">
            ...
            {duePayments.slice(0, 2).map((payment) => (
              <div
                key={payment.id}
                onClick={() => navigate(`/gas-bill/account/${payment.accountId}`)}
            ...
            {recentTransactions.slice(0, 3).map((transaction) => (
              <div
                key={transaction.id}
                onClick={() => navigate(`/gas-bill/account/${transaction.accountId}`)}
          ...
          <TabsContent value="accounts" className="mt-6 space-y-3">
            ...
            {savedAccounts.map((account) => (
              <div
                key={account.id}
                onClick={() => navigate(`/gas-bill/account/${account.id}`)}
                className="cursor-pointer border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent hover:border-white/20 transition-all p-4"
          ...
          <TabsContent value="transactions" className="mt-6 space-y-3">
            ...
            {allTransactions.map((transaction) => (
              <div
                key={transaction.id}
                onClick={() => navigate(`/gas-bill/transaction/${transaction.id}`)}
                className="cursor-pointer border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent hover:border-white/20 transition-all p-4"
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-4">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-white/80">
              <p className="font-light mb-1 tracking-wide">Safe & Secure Payments</p>
              <p className="text-[10px] text-white/50 uppercase tracking-widest">All gas bill payments are processed securely</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={paymentDialogOpen} onOpenChange={setPaymentDialogOpen}>
        <DialogContent className="bg-black border-white/20 text-white max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-white font-light text-xl tracking-wide">Pay Gas Bill</DialogTitle>
            ...
            <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-5">
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-light">{selectedAccount?.city}</span>
                </div>
                <div className="flex justify-between">
