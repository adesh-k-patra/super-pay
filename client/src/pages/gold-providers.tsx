...
import { ArrowLeft, Star, TrendingUp, Shield, Award, Search } from "lucide-react";

const goldProviders = [
  {
    id: "kalyan-digital-gold",
    name: "Kalyan Jewellers Digital Gold",
    provider: "Kalyan Jewellers",
    minInvestment: 100,
    purity: "99.99% 24K",
    currentRate: 6350,
    rating: 4.8,
    features: ["100% Pure Gold", "Instant Delivery", "Buyback Guaranteed", "MMTC-PAMP Certified"],
    logo: "🏆"
  },
  {
    id: "muthoot-digital-gold",
    name: "Muthoot Digital Gold",
    provider: "Muthoot FinCorp",
    minInvestment: 10,
    purity: "99.99% 24K",
    currentRate: 6345,
    rating: 4.7,
    features: ["Low Entry Barrier", "Zero Storage Cost", "Instant Liquidity", "BIS Hallmarked"],
    logo: "💎"
  },
  {
    id: "malabar-gold",
    name: "Malabar Digital Gold",
    provider: "Malabar Gold & Diamonds",
    minInvestment: 100,
    purity: "99.99% 24K",
    currentRate: 6355,
    rating: 4.9,
    features: ["Premium Quality", "Pan India Delivery", "Lifetime Buyback", "Swiss Gold"],
    logo: "👑"
  },
  {
    id: "tanishq-digital-gold",
    ...
    currentRate: 6360,
    rating: 4.8,
    features: ["Tata Trust", "Premium Service", "Exchange for Jewellery", "Augmont Certified"],
    logo: "✨"
  },
  {
    id: "paytm-gold",
    ...
    currentRate: 6340,
    rating: 4.5,
    features: ["Start from ₹1", "Instant Purchase", "Safe & Secure", "MMTC-PAMP Gold"],
    logo: "💰"
  },
  {
    id: "phonepe-gold",
    ...
    currentRate: 6342,
    rating: 4.6,
    features: ["Digital Locker", "SIP Available", "Zero Charges", "Augmont Gold"],
    logo: "🪙"
  },
  {
    id: "gpay-gold",
    ...
    currentRate: 6338,
    rating: 4.5,
    features: ["Trusted Platform", "Easy Investment", "MMTC Backed", "Insurance Cover"],
    logo: "🌟"
  },
  {
    id: "safegold",
    ...
    currentRate: 6348,
    rating: 4.7,
    features: ["India's Largest", "Vault Storage", "Physical Delivery", "LBMA Approved"],
    logo: "🔒"
  },
  {
    id: "pc-jeweller",
    name: "PC Jeweller Digital Gold",
    provider: "PC Jeweller",
    minInvestment: 500,
    purity: "99.99% 24K",
    currentRate: 6352,
    rating: 4.4,
    features: ["Exchange Benefits", "Premium Gold", "Certified Quality", "Store Credit"],
    logo: "💍"
  },
  {
    id: "reliance-jewels",
    name: "Reliance Jewels Gold",
    provider: "Reliance Jewels",
    minInvestment: 100,
    purity: "99.99% 24K",
    currentRate: 6358,
    rating: 4.6,
    features: ["Reliance Brand", "Pan India Network", "Gold Exchange", "Premium Service"],
    logo: "🏅"
  }
];

export default function GoldProviders() {
  const [, navigate] = useLocation();
  const [searchQuery, setSearchQuery] = useState("");

  const filteredProviders = goldProviders.filter(provider =>
    provider.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
    provider.provider.toLowerCase().includes(searchQuery.toLowerCase()) ||
    provider.purity.toLowerCase().includes(searchQuery.toLowerCase())
  );
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">DIGITAL GOLD</h1>
        ...
        <Tabs defaultValue="explore" className="w-full">
          ...
          <TabsContent value="explore" className="mt-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-xs text-white/60 font-light">{provider.purity}</span>
                      ...
                      <div className="text-right ml-4">
                        ...
                        <div className="text-xs text-white/40 font-light">/gram</div>
                      </div>
                    </div>

                    <div className="flex items-center justify-between pt-2 border-t border-white/10">
                      <div className="text-xs text-white/50 font-light">
                        Min. <span className="text-white font-medium">₹{provider.minInvestment}</span>
                      </div>
                      <div className="flex items-center gap-2">
            ...
            <div className="border border-white/20 p-6 bg-white/5">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white mb-2 tracking-wide uppercase text-sm">Why Digital Gold?</h4>
                  <ul className="space-y-1.5 text-sm text-white/60 font-light">
                    <li>• Start investing from as low as ₹1</li>
                    <li>• No making charges or storage costs</li>
                    <li>• Instant liquidity with buyback guarantee</li>
                    <li>• Option to convert to physical gold or jewellery</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="holdings" className="mt-6">
            <div className="border border-white/20 p-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl text-center">
              ...
              <h3 className="text-base font-semibold text-white mb-2 tracking-wide">NO GOLD HOLDINGS</h3>
              <p className="text-white/40 text-sm font-light mb-4">You don't have any gold investments yet</p>
              <Button
                onClick={() => navigate("/investment")}
          ...
          <TabsContent value="pay-history" className="mt-6">
            <div className="border border-white/20 p-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl text-center">
              ...
              <p className="text-white/40 text-sm font-light">Your gold purchase history will appear here</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
