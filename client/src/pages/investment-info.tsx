import { ArrowLeft, Check, TrendingUp, Shield, Zap, DollarSign, Clock, AlertTriangle, Target, BarChart3, Award, PieChart } from "lucide-react";
...
export default function InvestmentInfo() {
  ...
  const features = [
    { 
      ...
      desc: "Invest in stocks, mutual funds, SIPs, gold, silver, and fixed income instruments from one platform.",
      highlight: "10+ categories"
    },
    { 
      icon: BarChart3, 
      title: "EXPERT RECOMMENDATIONS", 
      desc: "Get AI-powered investment suggestions based on your risk profile and financial goals.",
      highlight: "AI-powered"
    },
    { 
      icon: DollarSign, 
      title: "START WITH ₹100", 
      desc: "Begin your investment journey with as low as ₹100 in mutual funds and SIPs.",
      highlight: "Low minimum"
    },
    { 
      icon: Shield, 
      title: "SECURE & REGULATED", 
      desc: "All investments are made through SEBI-registered partners with complete security and transparency.",
      highlight: "SEBI regulated"
    },
    { 
      icon: PieChart, 
      title: "PORTFOLIO TRACKING", 
      desc: "Monitor all investments in one dashboard with real-time updates and performance analytics.",
      highlight: "Live tracking"
    },
  ];

  const steps = [
    { step: "1", title: "Complete KYC", desc: "One-time verification with Aadhaar & PAN" },
    { step: "2", title: "Choose Investment", desc: "Select from stocks, MF, SIP, gold & more" },
    { step: "3", title: "Invest Amount", desc: "Start with as low as ₹100" },
    { step: "4", title: "Track Growth", desc: "Monitor portfolio and returns daily!" }
  ];

  const terms = [
    { label: "Minimum Investment", desc: "Start investing with minimal amount", value: "₹100" },
    { label: "Investment Types", desc: "Diverse investment categories", value: "10+ Options" },
    { label: "Portfolio Value", desc: "Track total investment value", value: "Real-time" },
    { label: "Tax Benefits", desc: "Save taxes with ELSS funds", value: "80C Available" },
    { label: "Exit Options", desc: "Sell anytime based on fund type", value: "Flexible" },
    { label: "Expert Support", desc: "Investment advisory assistance", value: "24/7 Help" },
  ];
    ...
    <div className="min-h-screen bg-black text-white pb-32">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">INVESTMENT</h1>
      ...
      <div className="pt-20 px-4 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="border border-white/20 p-5 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-white/60 leading-relaxed font-light max-w-3xl mx-auto">
              <span className="font-medium text-white">Investment</span> platform helps you build wealth systematically. Invest in stocks, mutual funds, SIPs, gold, and more with expert recommendations and complete portfolio tracking.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-white/50 text-[11px] font-light">Start investing in minutes</p>
        ...
        <div className="space-y-3">
          ...
          <div className="border border-white/20 p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                { title: "Wealth Creation", desc: "Grow money faster than savings" },
                { title: "Diversification", desc: "Invest across multiple assets" },
                { title: "Professional Guidance", desc: "AI and expert recommendations" },
                { title: "Tax Savings", desc: "Save taxes with ELSS investments" },
                { title: "Transparency", desc: "Real-time tracking and reports" },
                { title: "Flexibility", desc: "Invest and withdraw as needed" },
              ].map((item, idx) => (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-xs text-white/60 font-light leading-relaxed">
                Investments are subject to market risks. Past performance is not indicative of future returns. Please read all scheme-related documents carefully before investing. Recommendations are for informational purposes only - consult a financial advisor for personalized advice.
              </p>
