...
export default function LoanCongratulations() {
  ...
  const loanDetails = {
    ...
    loanNumber: "LOAN-" + Date.now().toString().slice(-10),
    loanAmount: "₹5,00,000",
    ...
    <div className="min-h-screen bg-black text-white pb-24">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">LOAN APPROVED</h1>
      ...
      <div className="pt-20 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-4">
          <p className="text-[10px] text-white/50 uppercase tracking-widest mb-4">Loan Details</p>
          
          <div className="space-y-3">
            <div className="flex justify-between py-2 border-b border-white/10">
              <div className="flex items-center gap-2">
                <FileText className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Loan Type</span>
              </div>
              <span className="text-sm text-white font-light">{loanDetails.loanType}</span>
            </div>

            <div className="flex justify-between py-2 border-b border-white/10">
              <div className="flex items-center gap-2">
                <Hash className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Loan Number</span>
              </div>
              <span className="text-sm text-white font-light font-mono">{loanDetails.loanNumber}</span>
            </div>
            ...
            <div className="flex justify-between py-2 border-b border-white/10">
              ...
              <span className="text-sm text-white font-light font-mono">{loanDetails.applicationId}</span>
            </div>

            <div className="flex justify-between py-2 border-b border-white/10">
              <div className="flex items-center gap-2">
                <Building2 className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Lender</span>
              </div>
              <span className="text-sm text-white font-light">{loanDetails.provider}</span>
            </div>
            ...
            <div className="flex justify-between py-2 border-b border-white/10">
              ...
              <span className="text-sm text-white font-semibold">{loanDetails.loanAmount}</span>
            </div>
            ...
            <div className="flex justify-between py-2 border-b border-white/10">
              ...
              <span className="text-sm text-white font-light">{loanDetails.interestRate}</span>
            </div>
            ...
            <div className="flex justify-between py-2 border-b border-white/10">
              ...
              <span className="text-sm text-white font-light">{loanDetails.tenure}</span>
            </div>

            <div className="flex justify-between py-2 border-b border-white/10">
              <div className="flex items-center gap-2">
                <CreditCard className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Monthly EMI</span>
              </div>
              <span className="text-sm text-white font-semibold">{loanDetails.emi}</span>
            </div>

            <div className="flex justify-between py-2 border-b border-white/10">
              <div className="flex items-center gap-2">
                <TrendingUp className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Processing Fee</span>
              </div>
              <span className="text-sm text-white font-light">{loanDetails.processingFee}</span>
            </div>
            ...
            <div className="flex justify-between py-2 border-b border-white/10">
              ...
              <span className="text-sm text-white font-light">{loanDetails.date}</span>
            </div>

            <div className="flex justify-between py-2">
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-white/40" />
                <span className="text-sm text-white/60">Disbursement Time</span>
              </div>
              <span className="text-sm text-white font-light">{loanDetails.disbursementTime}</span>
            </div>
          </div>
        </div>
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 bg-white/5 border border-white/10">
              ...
              <div>
                <p className="text-sm text-white font-medium mb-1">Loan Disbursement</p>
                <p className="text-xs text-white/60 font-light">
                  Funds will be credited to your account in {loanDetails.disbursementTime}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-white/5 border border-white/10">
              ...
              <div>
                <p className="text-sm text-white font-medium mb-1">EMI Reminders</p>
                <p className="text-xs text-white/60 font-light">
                  We'll send you reminders before each EMI payment is due
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/60 font-light leading-relaxed">
                Please ensure your bank account details are correct. The loan amount will be disbursed directly to your registered bank account. You'll receive a confirmation SMS and email once the disbursement is completed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-4 mb-32">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white font-light">loans@superpay.com</span>
            </div>
          </div>
        </div>
      </div>
