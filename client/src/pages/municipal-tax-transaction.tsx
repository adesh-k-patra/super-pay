...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home", propertyId: "MT123456", taxType: "Property Tax", city: "Mumbai", amount: 15000, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", taxPeriod: "2024-25 Q2", zone: "Zone 1" },
  { id: "2", accountId: "1", accountName: "Home", propertyId: "MT123456", taxType: "Property Tax", city: "Mumbai", amount: 15000, date: "10 Jun 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", taxPeriod: "2024-25 Q1", zone: "Zone 1" },
  { id: "3", accountId: "2", accountName: "Shop", propertyId: "MT789012", taxType: "Commercial Tax", city: "Mumbai", amount: 25000, date: "05 Jun 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", taxPeriod: "2024-25 Q1", zone: "Zone 2" },
];

export default function MunicipalTaxTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/municipal-tax/transaction/:id");
    ...
    <div className="min-h-screen bg-black text-white pb-32">
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6 text-center">
          ...
          <h2 className="text-3xl font-light text-white tracking-tight mb-2">₹{transaction.amount.toLocaleString()}</h2>
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          <h3 className="text-[10px] text-white/50 uppercase tracking-widest font-light mb-4">Property Information</h3>
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Property ID</span>
              <span className="text-white font-light">{transaction.propertyId}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Tax Type</span>
              <span className="text-white font-light">{transaction.taxType}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">City</span>
              <span className="text-white font-light">{transaction.city}</span>
            </div>
          </div>
        </div>

        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          <h3 className="text-[10px] text-white/50 uppercase tracking-widest font-light mb-4">Tax Details</h3>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Tax Period</span>
              <span className="text-white font-light">{transaction.taxPeriod}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Zone</span>
              <span className="text-white font-light">{transaction.zone}</span>
            </div>
          </div>
        </div>
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white font-light">₹{transaction.amount.toLocaleString()}</span>
            </div>
          </div>
        </div>
