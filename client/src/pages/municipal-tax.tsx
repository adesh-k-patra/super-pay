...
const savedAccounts = [
  { id: "1", name: "Home Property", propertyId: "PT123456", city: "Delhi", taxType: "Property Tax", lastBillAmount: 12500, dueDate: "31 Mar 2025", status: "Due" },
  { id: "2", name: "Shop", propertyId: "PT789012", city: "Mumbai", taxType: "Property Tax", lastBillAmount: 25000, dueDate: "31 Mar 2025", status: "Due" },
  { id: "3", name: "Water Tax", propertyId: "WT345678", city: "Delhi", taxType: "Water Tax", lastBillAmount: 2400, dueDate: "31 Mar 2025", status: "Due" },
  { id: "4", name: "Office Building", propertyId: "PT456789", city: "Bangalore", taxType: "Property Tax", lastBillAmount: 45000, dueDate: "31 Mar 2025", status: "Due" },
  { id: "5", name: "Warehouse", propertyId: "PT234567", city: "Pune", taxType: "Property Tax", lastBillAmount: 18000, dueDate: "31 Mar 2025", status: "Due" },
  { id: "6", name: "Apartment", propertyId: "PT890123", city: "Chennai", taxType: "Property Tax", lastBillAmount: 8500, dueDate: "31 Mar 2025", status: "Due" },
  { id: "7", name: "Trade License", propertyId: "TL567890", city: "Kolkata", taxType: "Trade License", lastBillAmount: 5000, dueDate: "31 Mar 2025", status: "Due" },
];

const recentTransactions = [
  { id: "1", accountId: "1", accountName: "Home Property", city: "Delhi", taxType: "Property Tax", amount: 12500, date: "31 Mar 2024", status: "Paid", time: "02:30 PM" },
  { id: "2", accountId: "2", accountName: "Shop", city: "Mumbai", taxType: "Property Tax", amount: 25000, date: "31 Mar 2024", status: "Paid", time: "11:45 AM" },
  { id: "3", accountId: "3", accountName: "Water Tax", city: "Delhi", taxType: "Water Tax", amount: 2400, date: "31 Mar 2024", status: "Paid", time: "03:15 PM" },
];

const allTransactions = [
  ...recentTransactions,
  { id: "4", accountId: "1", accountName: "Home Property", city: "Delhi", taxType: "Property Tax", amount: 12500, date: "31 Mar 2023", status: "Paid", time: "10:00 AM" },
  { id: "5", accountId: "2", accountName: "Shop", city: "Mumbai", taxType: "Property Tax", amount: 24000, date: "31 Mar 2023", status: "Paid", time: "04:20 PM" },
  { id: "6", accountId: "3", accountName: "Water Tax", city: "Delhi", taxType: "Water Tax", amount: 2200, date: "31 Mar 2023", status: "Paid", time: "01:15 PM" },
  { id: "7", accountId: "4", accountName: "Office Building", city: "Bangalore", taxType: "Property Tax", amount: 43000, date: "31 Mar 2023", status: "Paid", time: "11:30 AM" },
  { id: "8", accountId: "5", accountName: "Warehouse", city: "Pune", taxType: "Property Tax", amount: 17500, date: "31 Mar 2023", status: "Paid", time: "03:45 PM" },
  { id: "9", accountId: "6", accountName: "Apartment", city: "Chennai", taxType: "Property Tax", amount: 8000, date: "31 Mar 2023", status: "Paid", time: "09:20 AM" },
  { id: "10", accountId: "7", accountName: "Trade License", city: "Kolkata", taxType: "Trade License", amount: 4800, date: "31 Mar 2023", status: "Paid", time: "02:10 PM" },
  { id: "11", accountId: "1", accountName: "Home Property", city: "Delhi", taxType: "Property Tax", amount: 11800, date: "31 Mar 2022", status: "Paid", time: "10:30 AM" },
  { id: "12", accountId: "2", accountName: "Shop", city: "Mumbai", taxType: "Property Tax", amount: 23000, date: "31 Mar 2022", status: "Paid", time: "04:00 PM" },
];

const duePayments = [
  { id: "d1", accountId: "1", accountName: "Home Property", city: "Delhi", taxType: "Property Tax", amount: 12500, dueDate: "31 Mar 2025" },
  { id: "d2", accountId: "2", accountName: "Shop", city: "Mumbai", taxType: "Property Tax", amount: 25000, dueDate: "31 Mar 2025" },
  { id: "d3", accountId: "3", accountName: "Water Tax", city: "Delhi", taxType: "Water Tax", amount: 2400, dueDate: "31 Mar 2025" },
];

const quickPayAmounts = [5000, 10000, 15000, 20000, 25000, 50000];
...
export default function MunicipalTax() {
  ...
  const handleProceedToPayment = () => {
    ...
    const paymentParams = new URLSearchParams({
      ...
      taxType: selectedAccount?.taxType || '',
      city: selectedAccount?.city || '',
      returnUrl: '/municipal-tax'
    });
  ...
  const getIconForTaxType = (taxType: string) => {
    if (taxType.toLowerCase().includes("property")) return <Home className="h-5 w-5 text-white/60" />;
    if (taxType.toLowerCase().includes("water")) return <Building className="h-5 w-5 text-white/60" />;
    ...
    <div className="min-h-screen bg-black text-white pb-20">
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-white/50 uppercase tracking-widest font-light">Property & Other Taxes</p>
          </div>
          <Button
            variant="ghost"
            size="sm"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-white/60">FY 2024-25</span>
                </div>
              </div>
              <p className="text-4xl font-light text-white tracking-tight" data-testid="text-total-tax">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-white/50 uppercase tracking-widest mt-1">{transaction.accountName} • {transaction.taxType}</p>
          ...
          <TabsContent value="accounts" className="mt-6 space-y-3">
            ...
            {savedAccounts.map((account) => (
              <div
                key={account.id}
                onClick={() => navigate(`/municipal-tax/account/${account.id}`)}
                className="cursor-pointer border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent hover:border-white/20 transition-all p-4"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    <div className="w-10 h-10 border border-white/20 flex items-center justify-center">
                      {getIconForTaxType(account.taxType)}
                    </div>
                    <div>
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-4">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-white/80">
              <p className="font-light mb-1 tracking-wide">Important Information</p>
              <ul className="text-[10px] text-white/50 uppercase tracking-widest space-y-1">
                <li>• Pay before due date to avoid late fees</li>
                <li>• Online payments are processed instantly</li>
                <li>• Tax rebates available for early payment</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <Dialog open={paymentDialogOpen} onOpenChange={setPaymentDialogOpen}>
        <DialogContent className="bg-black border-white/20 text-white max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-white font-light text-xl tracking-wide">Pay Tax</DialogTitle>
            <DialogDescription className="text-white/50 text-[10px] uppercase tracking-widest">
              {selectedAccount?.name} • {selectedAccount?.propertyId}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-5">
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-[10px] text-white/50 uppercase tracking-widest">Tax Type</span>
                  <span className="text-white font-light">{selectedAccount?.taxType}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="border-t border-white/10 pt-3 flex justify-between">
                  <span className="text-white font-light tracking-wide">Tax Amount</span>
        ...
        <AlertDialogContent className="bg-black border-white/20 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/60 text-sm">
              Are you sure you want to delete "{selectedAccount?.name}" ({selectedAccount?.propertyId})? This action cannot be undone.
