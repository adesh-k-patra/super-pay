...
export default function MutualFundCongratsPage() {
  ...
  const fundId = urlParams.get("id") || "1";
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="flex justify-center">
          <div className="w-24 h-24 rounded-none bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center animate-pulse border border-white/20">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-light text-white">Investment Successful!</h1>
          <p className="text-white/70">Your mutual fund investment has been confirmed</p>
        </div>
        ...
        <Card className="bg-white/10 border border-white/20 rounded-none">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="flex justify-between items-center text-sm">
              <span className="text-white/70">Investment Type</span>
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="text-white font-light">Confirmed</span>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li>• Units will be allotted at closing NAV</li>
                  <li>• You'll receive confirmation via email & SMS</li>
                  <li>• Track your investment in "My Investments"</li>
                  <li>• Start a SIP for regular investments</li>
                </ul>
              </div>
            </div>
          </CardContent>
