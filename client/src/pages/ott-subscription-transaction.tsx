...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Netflix Premium", subscriberNumber: "NF1234567890", provider: "Netflix", amount: 649, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "OTT123456789001", paymentMethod: "UPI", planType: "Premium Plan", renewalMonth: "Sep 2024" },
  { id: "2", accountId: "1", accountName: "Netflix Premium", subscriberNumber: "NF1234567890", provider: "Netflix", amount: 649, date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "OTT123456789002", paymentMethod: "UPI", planType: "Premium Plan", renewalMonth: "Aug 2024" },
  { id: "3", accountId: "2", accountName: "Prime Video", subscriberNumber: "PV9876543210", provider: "Amazon Prime", amount: 299, date: "05 Aug 2024", time: "02:45 PM", status: "Success", transactionId: "OTT123456789003", paymentMethod: "UPI", planType: "Annual Plan", renewalMonth: "Aug 2024" },
];

export default function OTTSubscriptionTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/ott-subscription/transaction/:id");
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Subscriber Number</span>
              <span className="text-white font-light">{transaction.subscriberNumber}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          <h3 className="text-[10px] text-white/50 uppercase tracking-widest font-light mb-4">Subscription Details</h3>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Renewal Month</span>
              <span className="text-white font-light">{transaction.renewalMonth}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Plan Type</span>
              <span className="text-white font-light">{transaction.planType}</span>
            </div>
          </div>
        </div>
