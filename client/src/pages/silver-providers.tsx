...
const silverProviders = [
  {
    id: "safegold-silver",
    name: "SafeGold Silver",
    provider: "SafeGold",
    minInvestment: 10,
    purity: "99.9% Pure",
    currentRate: 78,
    rating: 4.7,
    features: ["Vault Storage", "Physical Delivery", "LBMA Certified", "Instant Liquidity"],
    logo: "🔒"
  },
  {
    id: "mmtc-silver",
    ...
    currentRate: 79,
    rating: 4.8,
    features: ["Government Backed", "Swiss Technology", "Premium Quality", "Certified Bars"],
    logo: "🏛️"
  },
  {
    id: "augmont-silver",
    name: "Augmont Silver",
    provider: "Augmont Gold",
    minInvestment: 10,
    purity: "99.9% Pure",
    currentRate: 77.5,
    rating: 4.6,
    features: ["Digital Vault", "SIP Available", "Exchange Option", "Insurance Cover"],
    logo: "💎"
  },
  {
    id: "paytm-silver",
    ...
    currentRate: 77,
    rating: 4.5,
    features: ["Start from ₹1", "Instant Purchase", "Safe Storage", "Easy Redemption"],
    logo: "💰"
  },
  {
    id: "phonepe-silver",
    ...
    currentRate: 77.2,
    rating: 4.6,
    features: ["Digital Locker", "Zero Charges", "Secure Investment", "Quick Withdrawal"],
    logo: "🪙"
  },
  {
    id: "tanishq-silver",
    ...
    currentRate: 79.5,
    rating: 4.7,
    features: ["Tata Trust", "Exchange Benefits", "Premium Service", "Certified Quality"],
    logo: "✨"
  },
  {
    id: "muthoot-silver",
    ...
    currentRate: 78.5,
    rating: 4.5,
    features: ["Trusted Brand", "Buyback Guarantee", "Flexible Investment", "Pan India Service"],
    logo: "🏅"
  },
  {
    id: "gpay-silver",
    name: "Google Pay Silver",
    provider: "Google Pay",
    minInvestment: 1,
    purity: "99.9% Pure",
    currentRate: 76.8,
    rating: 4.4,
    features: ["Easy Access", "Trusted Platform", "Low Entry", "Instant Purchase"],
    logo: "🌟"
  }
];

export default function SilverProviders() {
  const [, navigate] = useLocation();
  const [searchQuery, setSearchQuery] = useState("");

  const filteredProviders = silverProviders.filter(provider =>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between py-4 px-4">
          ...
          <div className="text-center">
            <h1 className="text-base font-bold tracking-wider">DIGITAL SILVER</h1>
        ...
        <Tabs defaultValue="explore" className="w-full">
          ...
          <TabsContent value="explore" className="mt-6 space-y-6">
            ...
            <div className="border border-white/20 p-6 bg-white/5">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white mb-2 tracking-wide uppercase text-sm">Why Digital Silver?</h4>
                  <ul className="space-y-1.5 text-sm text-white/60 font-light">
                    <li>• More affordable than gold for small investors</li>
                    <li>• Industrial demand provides price stability</li>
                    <li>• Portfolio diversification benefits</li>
                    <li>• Convert to physical silver anytime</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="holdings" className="mt-6">
            <div className="border border-white/20 p-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl text-center">
              ...
              <h3 className="text-base font-semibold text-white mb-2 tracking-wide">NO SILVER HOLDINGS</h3>
              <p className="text-white/40 text-sm font-light mb-4">You don't have any silver investments yet</p>
              <Button
                onClick={() => navigate("/investment")}
          ...
          <TabsContent value="pay-history" className="mt-6">
            <div className="border border-white/20 p-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl text-center">
              ...
              <p className="text-white/40 text-sm font-light">Your silver purchase history will appear here</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
