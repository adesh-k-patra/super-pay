...
import { CheckCircle, Home, ArrowRightLeft, ArrowLeft } from "lucide-react";

export default function STPCongrats() {
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-light text-white tracking-wider">STP Started Successfully!</h1>
          <p className="text-white/60 font-light">Your systematic transfer plan is now active</p>
        </div>
        ...
        <div className="border border-white/20 p-6 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl rounded-none space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-white/60 text-xs uppercase tracking-widest font-light">Transfer Amount</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/5 border border-white/10 hover:border-white/20 transition-all cursor-pointer rounded-none p-5 text-center" onClick={() => navigate("/investment/stp")}>
            <div className="bg-white/10 border border-white/20 rounded-none p-3 inline-block mb-2">
              <ArrowRightLeft className="h-6 w-6 text-white" />
            </div>
            <p className="text-sm text-white font-light tracking-wider">My STPs</p>
          </div>
