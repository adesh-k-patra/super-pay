...
import { 
  ArrowLeft, Train, Calendar, Clock, Users, CreditCard, 
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/my-trips/trains")} data-testid="button-back-list">
            Back to Trains
          </Button>
        </div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-start gap-4">
              <div className="p-3 bg-white/10 border border-white/20 rounded-none">
                <Train className="h-8 w-8 text-white/80" strokeWidth={1} />
              </div>
              <div>
            ...
            <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6">
              <div className="mb-6">
                <h3 className="text-xs uppercase tracking-widest text-white/60 font-light flex items-center gap-2">
                  <Train className="h-4 w-4" strokeWidth={1} />
                  Train Details
                </h3>
              </div>
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 px-4">
                    <div className="relative">
                      ...
                      <Train className="h-5 w-5 text-white/80 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black px-1" strokeWidth={1} />
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Train Number</div>
                  ...
                  <div>
                    ...
                    <div className="font-medium flex items-center gap-1">
                      ...
                      {bookingData.seatClass || 'Sleeper'}
                    </div>
                  </div>
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Platform</div>
                    <div className="font-medium">Platform {bookingData.platform || 'TBA'}</div>
                  </div>
                  <div>
                    <div className="text-white/60 text-xs uppercase tracking-widest font-light">Coach</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-white/70 font-light">
                    Arrive at the station at least 30 minutes before departure for boarding.
                  </div>
                </div>
              </div>
            </div>
