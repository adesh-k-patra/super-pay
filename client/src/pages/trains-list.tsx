      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white tracking-wider">MY TRAINS</h1>
        ...
        <div className="bg-white/5 border border-white/10 mb-6 p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input
                  placeholder="Search by PNR, station, or train number..."
                  value={searchQuery}
        ...
        {isLoading ? (
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="flex-1 space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-semibold text-lg text-white">{train.operatorName || 'Train'}</h3>
                            <p className="text-sm text-white/50">PNR: {train.bookingReference}</p>
                          </div>
                        </div>
                        <Badge className={`${getStatusColor(train.status)} border`}>
                          {train.status}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-8">
                        <div>
                          <p className="text-2xl font-bold text-white">{formatTime(train.departureDate)}</p>
                        ...
                        <div>
                          <p className="text-2xl font-bold text-white">{train.arrivalTime || formatTime(train.departureDate)}</p>
                          <p className="text-white/60 flex items-center gap-1 mt-1">
                            <MapPin className="h-3 w-3" />
                            {train.toLocation}
                          </p>
                    ...
                    <div className="flex lg:flex-col items-center lg:items-end justify-between lg:justify-center gap-4">
                      <div className="text-right">
                        ...
                        <p className="text-2xl font-bold text-white">₹{parseFloat(train.totalAmount).toLocaleString()}</p>
                      </div>
                      <Button
                        variant="outline"
          ...
          <div className="bg-white/5 border border-white/10 p-12 text-center">
            <Train className="h-16 w-16 text-white/20 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-white mb-2">No trains found</h3>
