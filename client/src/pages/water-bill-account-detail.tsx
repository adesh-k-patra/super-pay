...
const savedAccounts = [
  { id: "1", name: "Home", consumerNumber: "1234567890", city: "Mumbai", provider: "Mumbai Water Supply", billAmount: "₹680", dueAmount: 680, dueDate: "30 Oct 2024", lastPaid: "18 Sep 2024" },
  { id: "2", name: "Parents Home", consumerNumber: "9876543210", city: "Pune", provider: "Other", billAmount: "₹450", dueAmount: 450, dueDate: "25 Oct 2024", lastPaid: "15 Sep 2024" },
  { id: "3", name: "Rental Property", consumerNumber: "5555666677", city: "Delhi", provider: "Delhi Jal Board", billAmount: "₹550", dueAmount: 550, dueDate: "28 Oct 2024", lastPaid: "12 Sep 2024" },
];

const allTransactions = [
  { id: "1", accountId: "1", amount: 680, date: "18 Sep 2024", status: "Success", time: "10:30 AM", billMonth: "September 2024" },
  { id: "2", accountId: "1", amount: 650, date: "15 Aug 2024", status: "Success", time: "03:15 PM", billMonth: "August 2024" },
  { id: "3", accountId: "2", amount: 450, date: "15 Sep 2024", status: "Success", time: "02:45 PM", billMonth: "September 2024" },
  { id: "4", accountId: "1", amount: 720, date: "18 Jul 2024", status: "Success", time: "11:45 AM", billMonth: "July 2024" },
  { id: "5", accountId: "3", amount: 550, date: "12 Sep 2024", status: "Success", time: "04:20 PM", billMonth: "September 2024" },
  { id: "6", accountId: "2", amount: 480, date: "15 Aug 2024", status: "Success", time: "01:15 PM", billMonth: "August 2024" },
];

const dueBills = [
  { id: "d1", accountId: "1", amount: 680, dueDate: "30 Oct 2024", billMonth: "October 2024" },
];

const billAmounts = [
  { id: "a1", amount: 500, label: "Partial Payment" },
  { id: "a2", amount: 680, label: "Full Bill", recommended: true },
  { id: "a3", amount: 1000, label: "Extra Payment" },
  { id: "a4", amount: 1500, label: "Advance Payment" },
];

export default function WaterBillAccountDetail() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/water-bill/account/:id");
  ...
  const handleProceedToPayment = () => {
    ...
    const paymentParams = new URLSearchParams({
      ...
      city: account.city,
      returnUrl: `/water-bill/account/${account.id}`
    });
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              onClick={() => {
                ...
                navigate(`/add-water-account?${params.toString()}`);
              }}
              className="text-white/60 hover:text-white hover:bg-white/10 p-2 rounded-none"
        ...
        <div className="border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 border border-white/20 flex items-center justify-center">
              <Droplets className="h-7 w-7 text-white/60" />
            </div>
            <div className="flex-1">
              <h2 className="text-white font-light text-xl tracking-wide mb-1">{account.name}</h2>
              <p className="text-[10px] text-white/50 uppercase tracking-widest">{account.city}</p>
            </div>
