...
const allTransactions = [
  { id: "1", accountId: "1", accountName: "Home", consumerNumber: "W1234567890", provider: "Mumbai Water Supply", amount: 450, date: "15 Sep 2024", time: "10:30 AM", status: "Success", transactionId: "TXN123456789001", paymentMethod: "UPI", units: "12,000 L", billPeriod: "Aug 2024" },
  { id: "2", accountId: "1", accountName: "Home", consumerNumber: "W1234567890", provider: "Mumbai Water Supply", amount: 425, date: "10 Aug 2024", time: "03:15 PM", status: "Success", transactionId: "TXN123456789002", paymentMethod: "UPI", units: "11,500 L", billPeriod: "Jul 2024" },
  { id: "3", accountId: "2", accountName: "Shop", consumerNumber: "W9876543210", provider: "Delhi Jal Board", amount: 680, date: "05 Aug 2024", time: "02:45 PM", status: "Success", transactionId: "TXN123456789003", paymentMethod: "UPI", units: "15,000 L", billPeriod: "Jul 2024" },
];

export default function WaterBillTransaction() {
  const [, navigate] = useLocation();
  const [, params] = useRoute("/water-bill/transaction/:id");
      ...
      <div className="pt-20 pb-6 px-4 space-y-6 w-full max-w-screen-lg mx-auto">
        ...
        <div className="border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent backdrop-blur-xl p-5">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-white/60 font-light">Water Consumed</span>
